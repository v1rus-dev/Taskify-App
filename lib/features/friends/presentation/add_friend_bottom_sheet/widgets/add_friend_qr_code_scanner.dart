...
class AddFriendQrCodeScanner extends StatefulWidget {
  const AddFriendQrCodeScanner({super.key, required this.controller});

  final TextEditingController controller;

  @override
  State<AddFriendQrCodeScanner> createState() => _AddFriendQrCodeScannerState();
}
...
class _QrScannerMask extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    return CustomPaint(painter: _QrScannerMaskPainter());
  }
}
