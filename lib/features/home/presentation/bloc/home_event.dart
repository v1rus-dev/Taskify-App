...
class HomeEvent with _$HomeEvent {
  ...
  const factory HomeEvent.tasksUpdated(List<TaskWithSubTasksEntity> tasks) = _TasksUpdated;
  const factory HomeEvent.updateTaskCompletion(TaskWithSubTasksEntity task) = _UpdateTaskCompletion;
